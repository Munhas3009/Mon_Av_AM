                    ...
                    <table id="example2" class="table table-bordered table-hover">
                        <thead>
                            <tr>
                                ...
                                <th scope="col" class="actions text-center"><?= $this->Paginator->sort('classif') ?></th>
                                <th scope="col" class="actions text-center"><?= $this->Paginator->sort('distrito') ?></th>
                                <th scope="col" class="actions text-center"><?= $this->Paginator->sort('Nº_camas') ?></th>
