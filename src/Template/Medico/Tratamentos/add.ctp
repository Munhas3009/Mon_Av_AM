            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <?php echo $this->Form->control('unidade_id', ['options' => $unidades, 'empty' => true
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <?php echo $this->Form->control('especialidade_id', ['options' => $especialidades, 'empty' => true
                            , 'class' => 'form-control select2', 'style'=>'width: 100%;', 'label'=>'Especialidade']); ?>
                    </div>  
                    <!-- /.form-group -->

                    <div class="form-group">
                        <?php echo $this->Form->control('paciente_id', ['options' => $pacientes, 'empty' => true
